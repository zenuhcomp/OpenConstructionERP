...
const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      'Frontend: BIMPage.tsx hardcoded English strings replaced with i18n keys (deferred from v1.4.4 audit). UploadPanel + NonReadyOverlay + empty-state now go through useTranslation(). New bim.upload_* / bim.overlay_* keys added to i18n-fallbacks.ts. The HARD rule from the architecture guide is now honoured',
