...
export default function INExchangeModule() {
  ...
  const handlePrint = useCallback(() => {
    ...
    printBOQReport(exportablePositions, IN_TEMPLATE, {
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'import' && (
        <div className="space-y-5">
          ...
          {!importFile && <SampleTemplateButton template={IN_TEMPLATE} />}

          {/* CPWD Trade Sections reference */}
