...
export default function CZExchangeModule() {
  ...
  const handlePrint = useCallback(() => {
    ...
    printBOQReport(exportablePositions, CZ_TEMPLATE, {
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'import' && (
        <div className="space-y-5">
          ...
          {!importFile && <SampleTemplateButton template={CZ_TEMPLATE} />}

          {/* Czech trade sections reference */}
