...
export default function JPExchangeModule() {
  ...
  const handlePrint = useCallback(() => {
    ...
    printBOQReport(exportablePositions, JP_TEMPLATE, {
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'import' && (
        <div className="space-y-5">
          ...
          {!importFile && <SampleTemplateButton template={JP_TEMPLATE} />}

          {/* Sekisan Trade Sections reference */}
